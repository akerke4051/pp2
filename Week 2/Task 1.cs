...
namespace Palindrome
{
    class Program
    {
        ...
        static void Main(string[] args) //since it's static, we can call the function without instance of class, here a runtime state the execution.
            ...
            FileStream fs = new FileStream(@"C:\Users\Akerke\source\repos\task1lab2\abba.txt", FileMode.Open, FileAccess.ReadWrite);//it opens Filestream of shown path with the specified mode and gets acces to read or write on document
